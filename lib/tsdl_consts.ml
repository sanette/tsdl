...
let sdl_hint_render_logical_size_mode = "SDL_RENDER_LOGICAL_SIZE_MODE"
...
let sdl_hint_audio_resampling_mode = "SDL_AUDIO_RESAMPLING_MODE"
...
let sdl_blendoperation_add = 1
let sdl_blendoperation_subtract = 2
let sdl_blendoperation_rev_subtract = 3
let sdl_blendoperation_maximum = 5
let sdl_blendoperation_minimum = 4
let sdl_blendfactor_zero = 1
let sdl_blendfactor_one = 2
let sdl_blendfactor_src_color = 3
let sdl_blendfactor_one_minus_src_color = 4
let sdl_blendfactor_src_alpha = 5
let sdl_blendfactor_one_minus_src_alpha = 6
let sdl_blendfactor_dst_color = 7
let sdl_blendfactor_one_minus_dst_color = 8
let sdl_blendfactor_dst_alpha = 9
let sdl_blendfactor_one_minus_dst_alpha = 10
...
let sdl_scalemodelinear = 1
let sdl_scalemodebest = 2
...
let sdl_window_mouse_capture = 16384
let sdl_window_always_on_top = 32768
let sdl_window_skip_taskbar = 65536
let sdl_window_utility = 131072
let sdl_window_tooltip = 262144
let sdl_window_popup_menu = 524288
let sdl_window_vulkan = 268435456
let sdl_window_metal = 536870912
let sdl_windowpos_centered = 805240832
let sdl_windowpos_undefined = 536805376
let sdl_hittest_normal = 0
let sdl_hittest_draggable = 1
let sdl_hittest_resize_topleft = 2
let sdl_hittest_resize_top = 3
let sdl_hittest_resize_topright = 4
let sdl_hittest_resize_left = 9
let sdl_hittest_resize_right = 5
let sdl_hittest_resize_bottomleft = 8
let sdl_hittest_resize_bottom = 7
let sdl_hittest_resize_bottomright = 6
...
let sdl_gl_context_release_behavior = 24
...
let sdl_joystick_power_unknown = -1
let sdl_joystick_power_low = 1
let sdl_joystick_power_medium = 2
let sdl_joystick_power_full = 3
let sdl_joystick_power_max = 5
let sdl_joystick_power_wired = 4
let sdl_joystick_type_unknown = 0
let sdl_joystick_type_gamecontroller = 1
let sdl_joystick_type_wheel = 2
let sdl_joystick_type_arcade_stick = 3
let sdl_joystick_type_flight_stick = 4
let sdl_joystick_type_dance_pad = 5
let sdl_joystick_type_guitar = 6
let sdl_joystick_type_drum_kit = 7
let sdl_joystick_type_arcade_pad = 8
let sdl_joystick_type_throttle = 9
...
let sdl_controller_button_max = 21
let sdl_query = -1
let sdl_disable = 0
let sdl_enable = 1
let sdl_pressed = 1
...
let sdl_localechanged = 263
let sdl_displayevent = 336
...
let sdl_droptext = 4097
let sdl_dropbegin = 4098
let sdl_dropcomplete = 4099
let sdl_audiodeviceadded = 4352
let sdl_audiodeviceremoved = 4353
let sdl_sensorupdate = 4608
let sdl_render_targets_reset = 8192
let sdl_render_device_reset = 8193
...
let sdl_windowevent_take_focus = 15
let sdl_windowevent_hit_test = 16
